<?php
	/**
	 * @file views/default/post/forms/longtext_without_tinymce.php
	 * @brief If the plugin tinymce is enabled, the comment input will be displayed using this view
	 */
...
<!-- show the textarea -->
<textarea class="input-textarea mceNoEditor" name="<?php echo $vars['internalname']; ?>" <?php echo $vars['js']; ?>><?php echo htmlentities($vars['value'], null, 'UTF-8'); ?></textarea> 
