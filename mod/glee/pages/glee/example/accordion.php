...
$content = <<<HTML
     <div id="accordion2" class="accordion">
      ...
      <div class="accordion-group">
       <div class="accordion-heading">
        <a href="#collapse5" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
      ...
      <div class="accordion-group">
       <div class="accordion-heading">
        <a href="#collapse6" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
      ...
      <div class="accordion-group">
       <div class="accordion-heading">
        <a href="#collapse7" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
      ...
      <div class="accordion-group">
       <div class="accordion-heading">
        <a href="#collapse8" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
...
// display the page
echo elgg_view_page("phloor bootstrap accordion example", $body);
