...
function getGroupInformation_query($group_guid)
{
	...
	FROM elggentities e, elgggroups_entity eg, elggusers_entity ue
...
function getMemberInformation_query($group_guid)
{
	...
	FROM elggentities e, elggentity_relationships er, elggusers_entity ue
...
function getGroupActivityInformation_query($group_guid)
{
	...
	FROM elggentities e, elggentity_subtypes es, elggobjects_entity oe, elggusers_entity ue
...
function getDiscussionReplies_query($group_guid)
{
	...
	FROM elggannotations a, elggmetastrings ms, elggentities e, elggentity_subtypes es, elggobjects_entity oe, elggusers_entity ue
...
function getGroupPhotoInformation_query($album_guid)
{
	...
	FROM elggusers_entity ue, elggobjects_entity oe, elggentity_subtypes es, elggentities e
