...
/* +++[ GROUP STATISTICS ]++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
	...
	echo '<br/><code><u>'.elgg_echo('c_stats:general_group_info-heading').'</u></code><br/>';
	...
	if (count($result) > 0)
	{
		echo '<br/><code><u>'.elgg_echo('c_stats:group_activity_statistics-heading').'</u></code><br/>';
	...
	if (count($result) > 0)
	{
		echo '<br/><code><u>'.elgg_echo('c_stats:detailed_entities_statistics1-heading').'</u></code><br/>';
		echo "<table width='100%' cellpadding='0' cellspacing='0' class='db-table'>";
	...
	if (count($result) > 0)
	{
		echo '<br/><code><u>'.elgg_echo('c_stats:detailed_entities_statistics2-heading').'</u></code><br/>';
		echo "<table width='100%' cellpadding='0' cellspacing='0' class='db-table'>";
	...
	if (count($result) > 0)
	{
		echo '<br/><code><u>'.elgg_echo('c_stats:group_topic_replies_info-heading').'</u></code><br/>';
		echo "<table width='100%' cellpadding='0' cellspacing='0' class='db-table'>";
	...
	if (count($result) > 0)
	{
		echo '<br/><code><u>'.elgg_echo('c_stats:group_entity_replies-heading').'</u></code><br/>';
		echo "<table width='100%' cellpadding='0' cellspacing='0' class='db-table'>";
...
//		echo '</table>';
	...
	{
		echo '<br/><code><u>'.elgg_echo('c_stats:group_photos_information-heading').'</u></code><br/>';
