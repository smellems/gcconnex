<?php
	...
	error_log('cyu -  call to cli.php file :-D');
			...
			if(advanced_notifications_validate_secret($secret)){
				...
				switch($type) {
					case "object":
						...
						// save the information for email... :P
						c_notifications_entity_notification_mail();
						break;
					case "annotation":
						advanced_notifications_annotation_notification($id, $event);
						// save the information for email... :P
						c_notifications_annotation_notification_mail();
						break;
					default:
