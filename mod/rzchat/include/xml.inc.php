...
class RzXml
{
	...
	function getValue($sXmlContent, $sXmlTagName, $sName)
	{
		$aValues = $this->getValues($sXmlContent, $sXmlTagName);
	...
	function setValue($sXmlContent, $sXmlTagName, $sName, $sValue)
	{
		$aKeyValues = Array($sName => $sValue);
		return $this->setValues($sXmlContent, $sXmlTagName, $aKeyValues);
	}
